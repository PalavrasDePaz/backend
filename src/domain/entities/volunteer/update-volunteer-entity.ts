...
export type UpdateVolunteerEntity = Partial<
  Omit<VolunteerEntity,'pep' | 'idvol'| 'createdAt'| 'isDisability'| 'opportunities'| 'notebookPermission'| 'bookclubPermission'| 'authorization'| 'certificate'| 'courseOne'| 'courseTwo'
  > &

...
const models: TsoaRoute.Models = {
  ...
  EvaluateNotebookEntity: {
    dataType: 'refAlias',
    type: {
      ref: 'Omit_%2F%2Feslint-disable-next-lineprettier%2FprettierNotebookEntity.idcad-or-studentName-or-studentRegistration-or-idpep-or-reservationDate-or-evaluatedDate-or-notebookDirectory_',
      validators: {}
    }
  },
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  ...
  app.patch(
    ...
    async function BookClubClassAPI_updateConcluded(
      ...
      try {
        ...
        const promise = controller.updateConcluded.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, 200, next);
  ...
  app.get(
    ...
    async function BookEvaluationAPI_getVBookEvaluationList(
      ...
      try {
        ...
        const promise = controller.getVBookEvaluationList.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, 200, next);
  ...
  app.get(
    ...
    async function BookEvaluationAPI_getVBookEvaluationListDownload(
      ...
      try {
        ...
        const promise = controller.getVBookEvaluationListDownload.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, 200, next);
  ...
  app.get(
    ...
    async function BookEvaluationAPI_getBookEvaluationByClassId(
      ...
      try {
        ...
        const promise = controller.getBookEvaluationByClassId.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, 200, next);
  ...
  app.get(
    ...
    async function NotebookAPI_getNotebooksEvaluation(
      ...
      try {
        ...
        const promise = controller.getNotebooksEvaluation.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, 200, next);
  ...
  app.get(
    ...
    async function NotebookAPI_getNotebooksEvaluationDownload(
      ...
      try {
        ...
        const promise = controller.getNotebooksEvaluationDownload.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, 200, next);
  ...
  app.get(
    ...
    async function PepAPI_getClasses(request: any, response: any, next: any) {
      ...
      try {
        ...
        const promise = controller.getClasses.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, 200, next);
